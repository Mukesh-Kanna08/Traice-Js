 package com.simplilearn.employee_review.config;
import com.simplilearn.employee_review.entity.User;
import com.simplilearn.employee_review.entity.Status;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        ...
        // disable HTTP methods for Status: PUT, POST and DELETE
        config.getExposureConfiguration()
                .forDomainType(Status.class)
                .withItemExposure((metdata, httpMethods) -> httpMethods.disable(theUnsupportedActions))
                .withCollectionExposure((metdata, httpMethods) -> httpMethods.disable(theUnsupportedActions));

        // disable HTTP methods for Form: PUT, POST and DELETE
        config.getExposureConfiguration()
